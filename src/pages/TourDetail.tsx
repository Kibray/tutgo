    ...
    <div className="min-h-screen bg-background pb-28">
      ...
      <div className="relative h-[300px] md:h-[400px]">
        ...
        <button
          ...
          className="absolute top-4 left-4 w-[34px] h-[34px] rounded-[10px] bg-black/60 backdrop-blur-[10px] flex items-center justify-center"
        >
          <ChevronLeft className="w-5 h-5 text-white" />
        </button>
        <button className="absolute top-4 right-4 w-[34px] h-[34px] rounded-[10px] bg-black/60 backdrop-blur-[10px] flex items-center justify-center">
