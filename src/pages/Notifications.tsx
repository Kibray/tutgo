      ...
      <div className="px-4 pt-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg font-bold font-display text-foreground">Уведомления</h1>
          </div>
          {unreadCount > 0 && (
            <motion.button
              whileTap={{ scale: 0.95 }}
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-xs text-muted-foreground/60 mt-1">Здесь будут уведомления о записях и акциях</p>
          </div>
        ) : (
